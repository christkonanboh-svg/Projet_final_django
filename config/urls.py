...
from frontend_views import (
    ...
    AdminInsuranceView, AdminNotificationsView, AdminProfileView, AdminUsersView,
    AgentChatView, AgentCreditsView, AgentDashboardView,
    AgentNotificationsView, AgentProfileView,
    AppLoginView,
...
urlpatterns = [
    ...
    path("chat/", TemplateView.as_view(template_name="chat/index.html"), name="chat-index"),
    path("chat/client/", TemplateView.as_view(template_name="chat/client.html"), name="chat-client"),
    path("chat/agent/", TemplateView.as_view(template_name="chat/agent.html"), name="chat-agent"),
    # Auth
